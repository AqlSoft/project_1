						...
						<div class="accordion-item">
							...
							<h2 class="accordion-header">
								<button class="accordion-button" data-bs-toggle="collapse" data-bs-target="#collapse_{{ $contract->id }}" type="button"
									...
									{{ str_pad(++$b, 3, '0', STR_PAD_LEFT) }} - {{ $contract->the_client->a_name }} - الوقت المتبقى {{ $contract->remainingDays }} يوم/أيام
								</button>
							</h2>
						...
						<div class="accordion-item">
							...
							<h2 class="accordion-header">
								<button class="accordion-button" data-bs-toggle="collapse" data-bs-target="#collapse_{{ $contract->id }}" type="button"
									...
									{{ str_pad(++$a, 3, '0', STR_PAD_LEFT) }} - {{ $contract->the_client->a_name }} - انتهى العقد منذ {{ ABS($contract->remainingDays) }}
									يوم/أيام
								</button>
							</h2>
