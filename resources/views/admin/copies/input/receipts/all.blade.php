...
@endsection
@section('links')
    <button class="btn btn-sm btn-primary"><a href="{{ route('receipts.input.create', 1) }}"><span class="btn-title">إضافة
                ...
                <div class="col col-8">
                    <div class="input-group">
                        ...
                        <input type="text" data-search-token="{{ csrf_token() }}"
                            data-search-url="{{ route('receipts.search_input_receipts') }}" class="form-control"
                ...
                @if ($type != 2)
                    <table class="w-100">
                        ...
                        <tbody>
                            ...
                            @else
                                <tr>
                                    <td colspan="6"> لا يوجد سندات قيد التشغيل</td>
                                </tr>
                            @endif
                        </tbody>
                    </table>
                                ...
                                @foreach ($receipts as $in => $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('receipt.park', [$item->id, 0]) }}"
