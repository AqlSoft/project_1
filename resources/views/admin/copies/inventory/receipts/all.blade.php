...
@endsection
@section('links')
    <button class="btn btn-sm btn-primary"><a href="{{ route('receipts.inventory.create', 1) }}"><span class="btn-title">إضافة
            ...
            <fieldset class="my-4 py-5">
                <legend class="p-0" style="background-clip: transparent; box-shadow: none">
                    <div class="legend-item d-inline-block {{ $type == 1 ? 'active' : '' }}" style="">
                        <a href="{{ route('receipts.inventory_receipts', [1]) }}"> سندات جارية </a>
                        <a data-bs-toggle="tooltip" data-bs-title="إضافة سند جديد"
                            href="{{ route('receipts.inventory.create', [1]) }}"><i class="fa fa-plus"></i></a>
                    </div>
                    <div class="legend-item d-inline-block {{ $type == 2 ? 'active' : '' }}">
                        <a href="{{ route('receipts.inventory_receipts', [2]) }}"> سندات معتمدة </a>
                    </div>
                </legend>
                @if ($type != 2)
                    <table class="w-100">
