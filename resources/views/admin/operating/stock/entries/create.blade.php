                            ...
                            @if ($box[$value->item_id]->totalQty != 0)
                                <form action="{{ route('receipts.storeInventoryReceipt') }}" method="POST">
                                    ...
                                    <div class="input-group border mb-2 w-75" style="display: flex; margin: auto">
                                        ...
                                        <div style="flex:1">
                                            <button type="submit" style="height: 100%; padding: 5px 16px">تسوية</button>
                                        </div>
                                    </div>
                                </form>
                            @endif
        ...
        <fieldset style="width: 90%">
            ...
            <div class="row receipt_info">
                ...
                <div class="col col-4">
                    ...
                    <span class="data">{{ $receipt->client->name }}</span>
                </div>
                ...
                <div class="col col-4">
                    ...
                    <span class="data">{{ $receipt->contract->s_number }}</span>
                </div>
            </div>
            ...
            @if (isset($entries) && count($entries))
                ...
                <div class="buttons">
                    <button class="btn btn-sm font-weight-bold btn-primary"><a
                            href="{{ route('receipts.inventory_receipts', [1]) }}">
                            سدات التسوية </a></button>
                    <button class="btn btn-sm font-weight-bold btn-primary"><a
                            href="{{ route('receipts.print_inventory_receipts', [$receipt->id]) }}">عرض</a></button>
