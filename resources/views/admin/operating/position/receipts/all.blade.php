        ...
        <nav>
            <div class="nav nav-tabs" id="nav-tab" role="tablist" style="border: 0">
                ...
                <button class="nav-link active">
                    <a>السندات </a> &nbsp;
                    <a href="{{ route('position.create') }}"><i class="fa fa-plus"></i> </a>
                </button>
            </div>
        </nav>
                ...
                <div class="search">
                    <div class="input-group">
                        ...
                        <input type="text" data-search-token="{{ csrf_token() }}"
                            data-search-url="{{ route('position.search') }}" class="form-control" id="aj_search_by_number"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-sm displayReceipt btn-block p-1 mb-1 bg-secondary"
                                            ...
                                            data-search-url="{{ route('position.info') }}" data-tab="1"
                                    ...
                                    <td>
                                        ...
                                        <span class="btn btn-sm btn-block p-1 mb-1 bg-secondary">بواسطة:
                                            {{ $item->the_admin }}</span>
                                             <span class="btn btn-sm btn-block p-1 mb-1 bg-success">العميل:
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('position.entries.create', [$item->id, 0]) }}"><i
                                                class="fa fa-sign-in-alt text-info" data-bs-toggle="tooltip"
                                                data-bs-title="تحديد طبالى لعملية الترتيب بموجب السند"></i></a>

                                        <a href="{{ route('position.edit', [$item->id]) }}"><i
                                        ...
                                        <a class="displayReceipt" data-receipt-id="{{ $item->id }}"
                                            ...
                                            data-search-url="{{ route('position.info') }}" data-tab="1"><i
                                                class="fa fa-eye text-primary" data-bs-toggle="tooltip"
                                                data-bs-title="عرض محتويات السند"></i></a>

                                        <a href="{{ route('position.print', [$item->id]) }}"><i
                                                class="fa fa-print text-primary px-1" data-bs-toggle="tooltip"
                                                data-bs-title="طباعة السند"></i></a>

                                        <a href="{{ route('position.destroy', [$item->id]) }}"
