...
@section('content')
    ...
    <div class="container pt-5">
        ...
        <div class="tab-content" id="nav-tabContent" style="background:#fff">
            ...
            {{-- {{ null != Session::get('receipt_id') ? 'saved' : 'null' }} --}}
            ...
            <form action="{{ route('delivery.store') }}" method="POST">
                ...
                <div class="input-group mt-1">
                    ...
                    <select class="form-control" id="driver" value="{{ old('driver') }}" name="driver"
                        ...
                        @foreach ($drivers as $item)
                            <option value="{{ $item->id }}" {{ old('driver') == $item->id ? 'selected' : '' }}>
                    ...
                    <label class="input-group-text" for="greg_date_picker">المندوب:</label>
                    <select class="form-control" value="{{ old('contact') }}" name="contact">
                ...
                <div class="input-group mt-1">
                    ...
                    <label class="input-group-text" id="s_number_label" data-serial="{{ $lor }}"> الرقم
                        المسلسل:
                        <input type="number" name="s_number" id="s_number_input" value="{{ $lor }}">
