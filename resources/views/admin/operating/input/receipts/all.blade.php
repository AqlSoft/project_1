                ...
                <div class="search">
                    <div class="input-group">
                        ...
                        <input type="text" data-search-token="{{ csrf_token() }}"
                            data-search-url="{{ route('reception.search') }}" class="form-control" id="aj_search_by_number"
                            placeholder="ابحث بالرقم المسلسل" data-tab="{{ $tab }}">
                        <input type="text" data-search-token="{{ csrf_token() }}"
                            data-search-url="{{ route('reception.search') }}" class="form-control"
                            id="aj_search_by_contract" placeholder="ابحث برقم العقد" data-tab="{{ $tab }}">
                        <input type="text" data-search-token="{{ csrf_token() }}"
                            data-search-url="{{ route('reception.search') }}" class="form-control" id="aj_search_by_client"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-sm displayReceipt btn-block p-1 mb-1 bg-secondary"
                                            ...
                                            data-search-url="{{ route('reception.info') }}" data-tab="1"
                                    ...
                                    <td>{{ $item->total_inputs ? $item->total_inputs : 0 }}</td>
                                    <td>
                                        @if ($tab == 1)
                                        ...
                                        @else
                                            ...
                                            <a href="{{ route('reception.park', [$item->id, 0]) }}"
                                                onclick="if(!confirm('are you sure?')return false)"><i
                                                    class="fas fa-ban text-info px-1" data-bs-toggle="tooltip"
                                                    data-bs-title="إتاحة السند للتعديل"></i></a>
                                        @endif
                                    </td>
                                </tr>
                            @endforeach
