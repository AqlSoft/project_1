                ...
                <div class="card-body row">
                    ...
                    <div class="col col-3 text-center mb-3">
                        <div class="border border-info">
                            <div class="p-5"><i data-bs-toggle="tooltip" data-bs-title="جميع السندات"
                                    class="text-primary fa-3x fas fa-cubes"></i></div>
                            <a href="{{ route('receipts.all', [1]) }}" class="p-2 fs-4 d-block bg-info"> جميع
                                العملــــــيات
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col col-3 text-center mb-3">
                        <div class="border border-info">
                            ...
                            <a href="{{ route('reception.home', [1]) }}" class="p-2 fs-4 d-block bg-info"> سندات
                                الإدخال
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col col-3 text-center mb-3">
                        <div class="border border-info">
                            ...
                            <a href="{{ route('delivery.home', 1) }}" class="p-2 fs-4 d-block bg-info"> سندات
                                الإخراج
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col col-3 text-center mb-3">
                        <div class="border border-info">
                            ...
                            <a href="{{ route('arrange.home', [1]) }}" class="p-2 fs-4 d-block bg-info">ترتيب
                                البضاعة على الطبالى</a>
                        </div>
                    </div>
                    ...
                    <div class="col col-3 text-center mb-3">
                        <div class="border border-info">
                            ...
                            <a href="{{ route('operating.inventory.receipts', [1]) }}" class="p-2 fs-4 d-block bg-info">
                                عمليات الجرد
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col col-3 text-center mb-3">
                        <div class="border border-info">
                            <div class="p-5"><i data-bs-toggle="tooltip" data-bs-title="السندات الملغاة والمحذوفة"
                                    class="text-primary fa-3x fas fa-dolly-flatbed"></i></div>
                            <a href="{{ route('position.home', [1]) }}" class="p-2 fs-4 d-block bg-info">
                                تسكين واخراج الطبالى
                            </a>
                        </div>
                    </div>
